...
class DispatcherTest extends PHPUnit_Framework_TestCase
{
	...
	public function testAutoDispatch()
	{
		...
		{
			$controller_name = ucfirst($action) . 'Controller';
	...
	public function testSaDispatch()
	{
		...
		{
			$controller_name = ucfirst($actions[$action]) . 'Controller';
			$controller = new $controller_name();
		...
		$tests = array(
			...
			array(
				...
				'result' => array(
					...
					'controller_name' => 'BoardIndexController',
				),
			),
			// A topic
			array(
			...
			array(
				...
				'result' => array(
					...
					'controller_name' => 'MessageIndexController',
				),
			),
			// Non-existing action
			array(
			...
			array(
				...
				'result' => array(
					...
					'controller_name' => 'RemoveTopicController',
				),
			),
		);
 ...
 */
class Site_Dispatcher_Tester extends SiteDispatcher
{
	/**
