 ...
 * @package Maillist
 */
class ManageMaillistController extends AbstractController
{
	/**
	 ...
	 */
	protected function _initFiltersSettingsForm()
	{
		global $txt;
		...
		$GLOBALS['elk']['hooks']->hook('modify_maillist_filter_settings', array(&$config_vars));
	 ...
	 * Initialize Mailist settings form.
	 */
	protected function _initParsersSettingsForm()
	{
		global $txt;
		...
		$GLOBALS['elk']['hooks']->hook('modify_maillist_parser_settings', array(&$config_vars));
	...
	protected function _settings()
	{
		...
		$GLOBALS['elk']['hooks']->hook('modify_maillist_settings', array(&$config_vars));
