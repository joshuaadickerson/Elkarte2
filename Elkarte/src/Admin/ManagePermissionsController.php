 ...
 * @package Permissions
 */
class ManagePermissionsController extends AbstractController
{
	/**
	...
	public function action_modify()
	{
		...
		if ($context['group']['id'] > 0)
		{
			...
			if ($parent != -2)
				$GLOBALS['elk']['errors']->fatal_lang_error('cannot_edit_permissions_inherited');
		}
	...
	protected function _settings()
	{
		...
		$GLOBALS['elk']['hooks']->hook('modify_permission_settings', array(&$config_vars));
