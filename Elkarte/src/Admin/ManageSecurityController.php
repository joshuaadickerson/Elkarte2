 ...
 * @package Security
 */
class ManageSecurityController extends AbstractController
{
	/**
	 ...
	 * Moderation settings.
	 */
	protected function _moderationSettings()
	{
		global $txt;
		...
		$GLOBALS['elk']['hooks']->hook('modify_moderation_settings', array(&$config_vars));
	 ...
	 * Security settings.
	 */
	protected function _securitySettings()
	{
		global $txt;
		...
		$GLOBALS['elk']['hooks']->hook('general_security_settings', array(&$config_vars));
	 ...
	 * Spam settings.
	 */
	protected function _spamSettings()
	{
		global $txt;
		...
		$GLOBALS['elk']['hooks']->hook('spam_settings', array(&$config_vars));
	 ...
	 */
	protected function _bbSettings()
	{
