...
class ReportsController extends AbstractController
{
	...
	public function action_index()
	{
		...
		$GLOBALS['elk']['hooks']->hook('report_types');
		...
		$GLOBALS['elk']['hooks']->hook('report_buttons');
	...
	public function action_staff()
	{
		...
		if (count($allStaff) > 300)
			$GLOBALS['elk']['errors']->fatal_lang_error('report_error_too_many_staff');
