 ...
 * @package Attachments
 */
class ManageAttachmentsController extends AbstractController
{
	/**
	...
	public function action_index()
	{
		...
		$subActions = array(
			...
			'avatars' => array(
				'controller' => 'ManageAvatarsController',
	...
	protected function _settings()
	{
		...
		$GLOBALS['elk']['hooks']->hook('modify_attachment_settings', array(&$config_vars));
	 ...
	 */
	protected function _pauseAttachmentMaintenance($to_fix, $max_substep = 0)
	{
		global $context, $txt;
