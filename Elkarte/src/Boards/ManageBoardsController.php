...
class ManageBoardsController extends AbstractController
{
	...
	public function action_main()
	{
		...
		$GLOBALS['elk']['hooks']->hook('boards_main');
	...
	public function action_cat()
	{
		...
		$GLOBALS['elk']['hooks']->hook('edit_category');
	}
	...
	public function action_board()
	{
		...
		$GLOBALS['elk']['hooks']->hook('edit_board');
	}
	...
	protected function _settings()
	{
		...
		$GLOBALS['elk']['hooks']->hook('modify_board_settings', array(&$config_vars));
