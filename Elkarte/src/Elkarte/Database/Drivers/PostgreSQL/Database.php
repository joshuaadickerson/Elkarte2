...
namespace Elkarte\Database\Drivers\PostgreSQL;

use Elkarte\Database\Drivers\AbstractDatabase;
...
class Database extends AbstractDatabase
{
	 ...
	 * @param resource|null $connection = null
	 */
	public function lastError($connection = null)
	{
		// Decide which connection to use
		$connection = $connection === null ? $this->_connection : $connection;
	...
	public function error($db_string, $connection = null)
	{
		...
		if (function_exists('log_error'))
			$GLOBALS['elk']['errors']->log_error($txt['database_error'] . ': ' . $query_error . (!empty($modSettings['enableErrorQueryLogging']) ? "\n\n" . $db_string : ''), 'database', $file, $line);
		...
		$GLOBALS['elk']['errors']->fatal_error($context['error_message'], false);
	}
	 ...
	 * @return boolean
	 */
	public function changeSchema($db_name = null, $connection = null)
	{
		return true;
	}
