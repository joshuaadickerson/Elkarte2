...
class Hooks
{
	 ...
	 */
	public function __construct(Debug $debug, $paths = null)
	//public function __construct(DatabaseInterface $db, Debug $debug, $paths = null)
	{
	...
	public static function init($debug = null, $paths = null)
	{
		//if ($db === null)
		//	$db = \database();
	...
	public static function get($debug = null, $paths = null)
	{
		global $elk;
