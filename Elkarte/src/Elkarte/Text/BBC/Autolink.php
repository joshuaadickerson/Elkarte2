...
class Autolink
{
	...
	public function parse(&$data)
	{
		...
		$GLOBALS['elk']['hooks']->hook('autolink_area', array(&$data, $this->bbc));
	}
	...
	protected function load()
	{
		...
		$GLOBALS['elk']['hooks']->hook('autolink_load', array(&$search_url, &$replace_url, &$search_email, &$replace_email, $this->bbc));
	...
	public function setPossibleAutolink($message)
	{
		...
		$GLOBALS['elk']['hooks']->hook('possible_autolink', array(&$possible_link, &$possible_email));
