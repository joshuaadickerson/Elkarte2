...
class Codes
{
	...
	public function getItemCodes()
	{
		...
		$GLOBALS['elk']['hooks']->hook('item_codes', array(&$item_codes));
	...
	public function getForParsing()
	{
		...
		$GLOBALS['elk']['hooks']->hook('bbc_codes_parsing', array(&$bbc, &$item_codes));
	...
	public function setForPrinting()
	{
		...
		$GLOBALS['elk']['hooks']->hook('bbc_set_printing', array($this));
