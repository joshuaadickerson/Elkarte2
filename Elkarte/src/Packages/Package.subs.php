...
function getPackageInfo($gzfilename)
{
	...
	$package = $GLOBALS['elk']['text']->htmlspecialchars__recursive($packageInfo->to_array());
...
function fetch_web_data($url, $post_data = '', $keep_alive = false, $redirection_level = 2)
{
	...
	{
		$fetch_data = new \Elkarte\Packages\CurlFetchWebdata(array(), $redirection_level);
...
{
	require_once(ELKDIR . '/Compat/Compat.subs.php');
}
