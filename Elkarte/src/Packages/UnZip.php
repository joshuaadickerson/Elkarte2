...
class UnZip
{
	...
	public function __construct($data, $destination, $single_file = false, $overwrite = false, $files_to_extract = null)
	{
		...
		if (!function_exists('gzinflate'))
			$GLOBALS['elk']['errors']->fatal_lang_error('package_no_zlib', 'critical');
	 ...
	 */
	protected function _read_endof_cdr()
	{
	 ...
	 */
	protected function _load_file_headers()
	{
		$pointer = 0;
		$i = 0;
	 ...
	 */
	protected function _read_local_header()
	{
	 ...
	 */
	protected function _determine_write_this()
	{
	 ...
	 */
	protected function _write_this_file()
	{
		$this->_skip = false;
		$this->_found = false;
	 ...
	 */
	protected function _check_general_purpose_flag()
	{
