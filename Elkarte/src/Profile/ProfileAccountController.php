...
class ProfileAccountController extends AbstractController
{
	 ...
	 */
	protected function _create_issued_warnings_list()
	{
	 ...
	 */
	protected function _preview_warning()
	{
		global $context;
	 ...
	 */
	protected function _save_warning()
	{
	 ...
	 * @return int
	 */
	protected function _issue_warning_pm()
	{
		global $context;
