...
class ProfileController extends AbstractController
{
	 ...
	 */
	protected function _define_profile_menu()
	{
		...
		$profile_areas = array(
			'info' => array(
				...
				'areas' => array(
					'summary' => array(
						'label' => $txt['summary'],
						'controller' => 'Elkarte\\Profile\\ProfileInfoController',
					...
					'showlikes' => array(
						...
						'controller' => 'Elkarte\\Likes\\LikesController',
					...
					'history' => array(
						'label' => $txt['history'],
						'controller' => 'Elkarte\\Profile\\ProfileHistoryController',
			...
			'edit_profile' => array(
				...
				'areas' => array(
					'account' => array(
						'label' => $txt['account'],
						'controller' => 'Elkarte\\Profile\\ProfileOptionsController',
			...
			'profile_action' => array(
				...
				'areas' => array(
					...
					'issuewarning' => array(
						...
						'controller' => 'Elkarte\\Profile\\ProfileAccountController',
					...
					'subscriptions' => array(
						...
						'controller' => 'Elkarte\\Profile\\ProfileSubscriptionsController',
	 ...
	 */
	protected function _build_profile_breadcrumbs()
	{
	 ...
	 */
	protected function _save_updates()
	{
		...
		if ($this->_completed_save)
		{
			...
			{
				$controller = new ProfileAccountController(new EventManager());
			...
			$GLOBALS['elk']['hooks']->hook('profile_save', array(&$profile_vars, &$post_errors, $this->_memID));
			...
			elseif (!empty($profile_vars))
			{
				...
				$GLOBALS['elk']['cache']->remove('member_data-profile-' . $this->_memID);
			}
		}
	}
	 ...
	 */
	protected function _check_password($check_password)
	{
