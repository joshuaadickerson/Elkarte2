...
class ProfileInfoController extends AbstractController
{
	...
	public function action_summary()
	{
		...
		$GLOBALS['elk']['hooks']->hook('profile_summary', array($this->_memID));
	 ...
	 */
	protected function _load_recent_topics()
	{
	 ...
	 */
	protected function _load_recent_posts()
	{
		global $context, $modSettings, $scripturl;
	 ...
	 */
	protected function _load_buddies()
	{
	 ...
	 */
	protected function _load_recent_attachments()
	{
