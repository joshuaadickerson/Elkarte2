 ...
 */
class ProfileSubscriptionsController extends AbstractController
{
	/**
	...
	public function action_subscriptions()
	{
		...
		if (empty($this->_gateways))
			$this->_errors->fatal_error($txt['paid_admin_not_setup_gateway']);
	 ...
	 */
	protected function _remove_invalid()
	{
		global $context;
	 ...
	 * @param int $memID
	 */
	protected function _orderDone($memID)
	{
		global $context;
	 ...
	 */
	protected function _confirmOrder($memID)
	{
		...
		{
			$this->_errors->fatal_lang_error('paid_sub_not_active');
		}
	 ...
	 */
	protected function _set_value_cost_context()
	{
		global $context, $modSettings, $txt;
	 ...
	 */
	protected function _set_payment_gatway_context($memID, $period)
	{
