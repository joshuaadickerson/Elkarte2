...
class RandomDisplayModule implements ModuleInterface
{
	...
	public static function hooks(EventManager $eventsManager)
	{
		...
		if (!empty($modSettings['enableFollowup']))
		{
			...
			$GLOBALS['elk']['hooks']->add('integrate_topic_query', 'Random_Display_Module::followup_topic_query', '', false);
			$GLOBALS['elk']['hooks']->add('integrate_display_message_list', 'Random_Display_Module::followup_message_list', '', false);
		}
