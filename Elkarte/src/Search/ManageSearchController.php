...
class ManageSearchController extends AbstractController
{
	...
	protected function _settings()
	{
		...
		$GLOBALS['elk']['hooks']->hook('modify_search_settings', array(&$config_vars));
	 ...
	 */
	protected function loadSearchAPIs()
	{
		...
		try
		{
			...
			foreach ($files as $file)
			{
				if ($file->isFile())
				{
					...
					$search_class_name = '\\ElkArte\\Search\\Drivers\\API\\' . $index_name;
