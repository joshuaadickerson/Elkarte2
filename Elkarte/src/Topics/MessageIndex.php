...
// @todo change this to TopicsList like BoardsList or maybe just get rid of it altogether?
use Elkarte\Elkarte\AbstractManager;

class MessageIndex extends AbstractManager
{
	/**
	...
	function messageIndexSort()
	{
		...
		$GLOBALS['elk']['hooks']->hook('messageindex_sort', array(&$sort_methods));
