 ...
 */
class RemoveTopicController extends AbstractController
{
	/**
	...
	public function action_restoretopic()
	{
		...
		{
			$this->_errors->fatal_lang_error('restored_disabled', 'critical');
		}
		...
		{
			$this->_errors->fatal_lang_error('restore_not_found', false, array('<ul><li>' . implode('</li><li>', $restorer->unfoundRestoreMessages(true)) . '</li></ul>'));
		}
	 ...
	 */
	protected function _verifyDeletePermissions()
	{
	 ...
	 */
	protected function _redirectBack($full_topic)
	{
		global $topic, $board;
	 ...
	 */
	protected function _checkApproval()
	{
