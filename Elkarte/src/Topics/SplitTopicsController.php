 ...
 */
class SplitTopicsController extends AbstractController
{
	/**
	...
	public function action_splitIndex()
	{
		...
		if ($messageInfo === false)
			$this->_errors->fatal_lang_error('cant_find_messages');
		...
		if ($messageInfo['num_replies'] < 1)
			$this->_errors->fatal_lang_error('topic_one_post', false);
	...
	public function action_splitExecute()
	{
		...
		if (!empty($_SESSION['messageRedirect']) && empty($_SESSION['reason']))
		{
			...
			$this->_errors->fatal_lang_error('splittopic_no_reason', false);
		}
	...
	public function action_splitSelection()
	{
		...
		{
			$this->_unset_session_values();
			$this->_errors->fatal_lang_error('no_posts_selected', false);
		}
	 ...
	 */
	protected function _set_session_values()
	{
		global $txt;
	 ...
	 */
	protected function _unset_session_values()
	{
		unset(
