		...
		<div id="forumposts">
			<h2 class="category_header">
				...
				<span class="nextlinks">',
					...
					!empty($context['links']['derived_from']) ? ' - <a href="' . $context['links']['derived_from'] . '">' . sprintf($txt['topic_derived_from'], '<em>' . $GLOBALS['elk']['text']->shorten_text($context['topic_derived_from']['subject'], $modSettings['subject_length'])) . '</em></a>' : '',
				'</span>
			</h2>';
