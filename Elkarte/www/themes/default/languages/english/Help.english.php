...
$helptxt['enableOTP'] = 'Enabling this feature gives your users the ability to use a two-factor authentication using the Google Authenticator app for Android, iPhone, Blackberry and of other devices.';
